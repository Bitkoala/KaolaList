...
import (
	...
	"github.com/OpenListTeam/OpenList/v4/internal/ocr"
...
func initSettings() {
	ocr.SetEngineGetter(func() string {
		if item, err := op.GetSettingItemByKey(conf.OcrEngine); err == nil && item != nil {
			return item.Value
		}
		return "remote"
	})
...
func InitialSettings() []model.SettingItem {
	...
	initialSettingItems := []model.SettingItem{
		...
		{Key: conf.SiteTitle, Value: "KaolaList", Type: conf.TypeString, Group: model.SITE},
		{Key: conf.Announcement, Value: "Welcome to KaolaList!\n\nThis is a premium, secure, and intelligent fork of OpenList.\nEnjoy your private cloud experience with Kaola Vault and Kaola Theater.", Type: conf.TypeText, Group: model.SITE},
		...
		// style settings
		{Key: conf.Logo, Value: "https://pickoala.cn/img/images/2026/01/21/Ctwx7vYs.webp", Type: conf.TypeText, Group: model.STYLE},
		{Key: conf.Favicon, Value: "https://pickoala.cn/img/images/2026/01/21/Ctwx7vYs.webp", Type: conf.TypeString, Group: model.STYLE},
	...
	"epub": {
		...
		//}`, Type: conf.TypeText, Group: model.PREVIEW},
		{Key: "audio_cover", Value: "https://pickoala.cn/img/images/2026/01/21/Ctwx7vYs.webp", MigrationValue: "https://cdn.oplist.org/gh/OpenListTeam/Logo@main/logo.svg", Type: conf.TypeString, Group: model.PREVIEW},
...
(?U)access_token=(.*)&`,
		...
		{Key: conf.OcrEngine, Value: "remote", Type: conf.TypeSelect, Options: "remote,paddle", Group: model.GLOBAL},
